...
**Plans**: 4 plans
  ...
  - [x] 23-02-PLAN.md — Wave 1: build_scene_timings_from_cenas helper in src/reels_pipeline/timing.py + flip 3 tests
  - [x] 23-03-PLAN.md — Wave 2: run_step_srt tts_cenas kwarg + gated branch + route handler thread + flip 2 tests
  - [x] 23-04-PLAN.md — Wave 3: concat_clips_with_audio integration test + editor regression lock + flip 2 tests
...
**Plans**: 4 plans
  - [ ] 24-01-PLAN.md — Wave 0: xfail test stubs for SCRIPT-01..SCRIPT-06 in tests/test_reels_script_schema.py
  - [ ] 24-02-PLAN.md — Wave 1: ROTEIRO_SCHEMA extension + Pydantic models + migrate_legacy_roteiro() + flip 5 tests
  - [ ] 24-03-PLAN.md — Wave 2: system prompt updates (7 templates) + character_card injection + flip 2 tests
...
| 24. Script Schema v2 | 0/4 | Not started | - |
