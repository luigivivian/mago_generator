...
class AdCreateRequestV2(BaseModel):
    ...
    video_model: str = Field(default="kling-3.0/video", description="Video generation model")
    scene_prompts: list[str] = Field(default_factory=list, description="Per-scene video prompts (editable by user)")
